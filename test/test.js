...
contract("Simulation", async accounts => {
    ...
    let rewardPool= accounts[7];
    let treasuryPool = accounts[8];
    let liquidityPool = accounts[9];
    ...
    before('Initial Setup', async () => {
        ...
        router = await Router.at('0x2D99ABD9008Dc933ff5c0CD271B88309593aB921');
...
//         let priceTobePaid = web3.utils.toWei('5')


//         await MountainToken.createNodeAndTransferToPools.sendTransaction(priceTobePaid, 0, referral, {
//             from: alice,
//             gas: 4000000,
//           });
...
//         // 25 MNT
// 		var MNT_to_buy = web3.utils.toWei('25');
...
//         nodeMapping_alice = await MountainToken.getMountainNodeById(accountNodes_alice)
...
//         nodeMapping_bob = await MountainToken.getMountainNodeById(accountNodes_bob)
...
//     it("Bob buys token on TraderJoe and create a node of type 1", async() => {

		

//         // 5 MNT
// 		var MNT_to_buy = web3.utils.toWei('5');
// 		await buyMNT(bob, MNT_to_buy);

    
//         await MountainToken.createNodeAndTransferToPools.sendTransaction(MNT_to_buy, 0,referral, {
//             from: bob,
//             gas: 4000000,
//           });        
...
// }); 
//     it("Jack creates a node of type 3", async() => {

		

//         // 25 MNT
//         var MNT_to_buy = web3.utils.toWei('75');
//         await buyMNT(jack, MNT_to_buy);
//         var node_price = web3.utils.toWei('100');
...
//             nodeMapping_jack = await MountainToken.getMountainNodeById(accountNodes_jack)
//             nodeReward_jack = await MountainToken.calculateRewards(accountNodes_jack)    
            
//             console.log(accountNodes_jack.toString())
//             console.log(nodeMapping_jack.toString())
